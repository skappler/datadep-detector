...
public class DataSourceITCase {
	...
	public void testOrder1(){
		System.out.println("Executing testOrder1\n");
		// force and ignore static initializers
		DataSourceMod.RepoKind rk = DataSourceMod.RepoKind.GIT;
		System.out.println(HeapWalker.walkAndFindDependencies("INIT", "INIT"));
		testSetField();
		System.out.println("setField" + HeapWalker.walkAndFindDependencies("DataSourceITCase", "testSetField"));
		testSetKind();
		System.out.println("setKind"+HeapWalker.walkAndFindDependencies("DataSourceITCase", "testSetKind")); // depOn setField
		testSetCloneString();
		System.out.println("setCloneString"+HeapWalker.walkAndFindDependencies("DataSourceITCase", "testSetCloneString")); // depOn setField setKind
	}

	@Test
	public void testOrder2(){
		System.out.println("\nExecuting testOrder2\n");
		testSetField();
		System.out.println("setField" + HeapWalker.walkAndFindDependencies("DataSourceITCase", "testSetField"));
		testSetCloneString();
		System.out.println("setCloneString"+HeapWalker.walkAndFindDependencies("DataSourceITCase", "testSetCloneString")); //depOn setField
		testSetKind();
		System.out.println("setKind"+HeapWalker.walkAndFindDependencies("DataSourceITCase", "testSetKind")); // depOn setCloneString
	}
